...
namespace NetSparkle
{
    ...
    public class DefaultUIFactory : IUIFactory
    {
        ...
        public virtual IUserWindow CreateSparkleForm(Sparkle sparkle, AppCastItem[] updates, Icon applicationIcon, bool isUpdateAlreadyDownloaded = false)
        {
            return new UserWindow(sparkle, updates, applicationIcon, isUpdateAlreadyDownloaded);
        }
        ...
        {
            return new DownloadProgress(item, applicationIcon);
        }
