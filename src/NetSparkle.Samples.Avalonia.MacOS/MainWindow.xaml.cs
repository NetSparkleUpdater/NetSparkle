...
namespace NetSparkleUpdater.Samples.Avalonia
{
    public class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _sparkle = new SparkleUpdater("https://netsparkleupdater.github.io/NetSparkle/files/sample-app-macos/appcast.xml", new Ed25519Checker(Enums.SecurityMode.Strict, "8zPswEwycU7XQ7OcGQtI/b22pWo1qM2Ual2OhssaDyI="))
            {
